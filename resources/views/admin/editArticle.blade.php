            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{url('wSifGFeO5mQoCWB4/editArticle')}}" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return do_submit();">
                            <div class="form-body">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function do_submit() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('wSifGFeO5mQoCWB4/editArticle')}}",
                async: false,
