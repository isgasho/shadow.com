...
<head>
    ...
    <meta property="og:title" content="穿云梯VPN特价 | 穿云梯"/>
    ...
    <meta name="twitter:title" content="穿云梯VPN特价 | 穿云梯"/>
    <meta name="twitter:description"
          content="Happy Holidays and a Secure New Year! Enjoy 3 years of online security for only $99!"/>
    <meta name="twitter:image" content="/images/2017/12/holiday-deal-fb-01-1.png"/>
    <meta itemprop="image" content="/images/2017/12/holiday-deal-fb-01-1.png"/>
    <!-- /all in one seo pack -->
...
<noscript><img src="//bat.bing.com/action/0?ti=5060812&amp;Ver=2" height="0" width="0"
               style="display:none; visibility: hidden;"></noscript>
<script type="text/javascript" id="">var isStatusBarHovered = !1,
        statusBarUnprotectedElement = document.querySelector(".not-secured span") || document.querySelector('[data-user\x3d"not-secured"]');
    statusBarUnprotectedElement && statusBarUnprotectedElement.addEventListener("mouseenter", function (a) {
        dataLayer && !isStatusBarHovered && (dataLayer.push({
            eventCategory: "Unprotected",
            eventAction: "MouseOver",
            eventLabel: window.location.pathname,
            eventValue: 0,
            event: "GAEvent"
        }), isStatusBarHovered = !0)
    }, !1);</script>
<script type="text/javascript" id="">
    function crumbleCookie(a) {
        for (var b = document.cookie.split(";"), d = {}, e = 0; e < b.length; e++) {
            var f = b[e].substring(0, b[e].indexOf("\x3d")).trim(),
                g = b[e].substring(b[e].indexOf("\x3d") + 1, b[e].length).trim();
            d[f] = g
        }
        return a ? d[a] ? d[a] : null : d
    }

    function bakeCookie(a, b, d, e, f, g) {
        var c = new Date;
        c.setTime(c.getTime());
        d && (d *= 864E5);
        c = new Date(c.getTime() + d);
        document.cookie = a + "\x3d" + escape(b) + (d ? ";expires\x3d" + c.toGMTString() : "") + (e ? ";path\x3d" + e : "") + (f ? ";domain\x3d" + f : "") + (g ? ";secure" : "")
    }

    function writeLogic(a) {
        var b = getTrafficSource(a);
        b = b.replace(/\|{2,}/g, "|");
        b = b.replace(/^\|/, "");
        b = unescape(b);
        bakeCookie(a, b, 182, "/", ".nordvpn.com", "");
        bakeCookie("CurrentSession", b, 182, "/", ".nordvpn.com", "")
    }

    function getParam(a, b) {
        try {
            var d = a.match("[?\x26]" + b + "\x3d([^\x26]+)");
            return d ? d[1] : ""
        } catch (e) {
            return ""
        }
    ...
    function calculateTrafficSource() {
        var a = "", b = "", d = "", e = "", f = "",
            g = [["bing", "q"], ["google", "q"], ["yahoo", "q"], ["baidu", "q"], ["yandex", "q"], ["ask", "q"]],
            c = document.referrer;
        ref_domain = c = c.substr(c.indexOf("//") + 2);
        ref_path = "/";
        ref_search = "";
        var h = document.location.search;
        if (-1 < h.indexOf("utm_source")) a = getParam(h, "utm_source"), b = getParam(h, "utm_medium"), d = getParam(h, "utm_campaign"), e = getParam(h, "utm_term"), f = getParam(h, "utm_content"); else if (getParam(h, "gclid")) a = "google", b = "cpc", d = "(not set)"; else if (c) for (-1 <
                                                                                                                                                                                                                                                                                                c.indexOf("/") && (ref_domain = c.substr(0, c.indexOf("/")), ref_path = c.substr(c.indexOf("/")), -1 < ref_path.indexOf("?") && (ref_search = ref_path.substr(ref_path.indexOf("?") + 1), ref_path = ref_path.substr(0, ref_path.indexOf("?")))), b = "referral", a = ref_domain, c = 0; c < g.length; c++) if (-1 < ref_domain.indexOf(g[c][0])) {
            b = "organic";
            a = g[c][0];
            e = getParam(ref_search, g[c][1]) || "(not provided)";
            break
        }
        return {source: a, medium: b, campaign: d, term: e, content: f}
    }

    function getTrafficSource(a) {
        a = calculateTrafficSource();
        var b = 0 === a.source.length ? "direct" : a.source, d = 0 === a.medium.length ? "none" : a.medium,
            e = 0 === a.campaign.length ? "direct" : a.campaign;
        "referral" === d && (e = "");
        var f = new Date;
        return a = "source\x3d" + b + "\x26medium\x3d" + d + "\x26campaign\x3d" + e + "\x26term\x3d" + a.term + "\x26content\x3d" + a.content + "\x26date\x3d" + f.toISOString().slice(0, 10).replace(/-/g, "")
    }

    (function () {
        var a = crumbleCookie().FirstSession;
        "undefined" == typeof a ? writeLogic("FirstSession") : 0 > document.referrer.indexOf("nordvpn.com") && writeLogic("ReturningSession")
    })();</script>
<div style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon0.25564850900222513"><img
            style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon0.04882602309799555"
            width="0" height="0" alt=""
            src="https://bat.bing.com/action/0?ti=5060812&amp;Ver=2&amp;mid=3829f0ab-ac68-0a82-ae72-e688bf4bd6a3&amp;evt=pageLoad&amp;sid=ade9b060-0&amp;lt=4061&amp;pi=-1978200868&amp;lg=zh-CN&amp;sw=1536&amp;sh=864&amp;sc=24&amp;tl=%E4%B8%8B%E8%BD%BDVPN%E5%AE%A2%E6%88%B7%E7%AB%AF%EF%BC%9A%E8%AE%BE%E7%BD%AE%E5%92%8C%E4%BD%BF%E7%94%A8%E9%9D%9E%E5%B8%B8%E7%AE%80%E5%8D%95%EF%BC%81%20%7C%20NordVPN&amp;r=http%3A%2F%2Fshadow3.com%2Ffront%2Fservers&amp;p=https%3A%2F%2Fnordwebsite.net%2Fzh%2Fdownload%2F%3F_ga%3D2.70969108.564128612.1527559136-1417479074.1527559136&amp;msclkid=N&amp;rn=853826">
</div>
