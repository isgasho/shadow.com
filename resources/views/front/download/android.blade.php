    ...
    <div class="ScrollableTabs js-ScrollableTabs text-center">
        <div class="ScrollableTabs__wrapper">
            <ul class="List ScrollableTabs__items">
                <li class="ListItem ScrollableTabs__item px-md-5 d-inline-block ScrollableTabs__item--active"><a
                        ...
                        <div class="ScrollableTabs__active-divider" style="width: 49px;"></div>
                    </a></li>
                <li class="ListItem ScrollableTabs__item px-md-5 d-inline-block"><a
                            class="Link ScrollableTabs__link p-5 Link--dark"
                            href="/front/download/windows/"><span class="SVG-wrapper"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    class="SVG SVG--inline text-center scale-24 c-bw-14 mb-3"
                                    preserveAspectRatio="xMidYMid meet"><path
            ...
            <div class="ScrollableTabs__paddle"><a class="Link ScrollableTabs__paddle-left" href="#">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                         class="SVG SVG--inline c-bw-14" preserveAspectRatio="xMidYMid meet">
                        <path d="M8.667 8L4 3.333 5.333 2l6 6-6 6L4 12.667z" fill="#151922" fill-rule="evenodd"></path>
                    </svg>
                </a></div>
        </div>
    </div>
                    ...
                    <div class="Banner Banner--light">
                        <div class="d-sm-flex row">
                            <div class="pt-11 py-sm-11 py-md-14 my-auto col-sm-6 col-xs-12">
                                <h1 class="Title h2 mb-5 mb-sm-6 text-xs-center">为 Android 系统安装 NordVPN 应用程序</h1>
                            ...
                            <div class="my-auto col-sm-6 col-xs-12"><img
                                        src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/devices/banner-mobile-android-map-light.png"
                                        srcset="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/devices/banner-mobile-android-map-light.png 1x, https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/devices/banner-mobile-android-map-light@2x.png 2x"
                                        class="hidden-xs p-lg-6 my-6 my-sm-0 img-responsive" alt="iOS"><img
                                        src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/devices/banner-mobile-android-map-light.png"
                                        srcset="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/devices/banner-mobile-android-map-light.png 1x, https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/devices/banner-mobile-android-map-light@2x.png 2x"
                                        class="py-6 p-lg-6 visible-xs center-block img-responsive" alt="iOS"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{--<div class="container">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-xs-12 col-lg-offset-1 col-lg-10 text-center">--}}
                        ...
                        {{--<p class="Text mb-7">开始使用最好的 Android 版 VPN 保护您自己。</p>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="row">--}}
                    {{--<div class="col-xs-12 col-sm-4">--}}
                        {{--<div class="FeatureItem text-center px-md-6 py-7 py-sm-8"><img--}}
                                    {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/onboarding/sign-up.svg"--}}
                    ...
                    {{--<div class="col-xs-12 col-sm-4">--}}
                        {{--<div class="FeatureItem text-center px-md-6 py-7 py-sm-8"><img--}}
                                    {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/onboarding/download.svg"--}}
                                    {{--class="mb-6" alt="safe-wifi">--}}
                            {{--<h6 class="Title base mb-3 fwm">2. 获取 NordVPN 应用程序</h6>--}}
                            {{--<p class="Text small mb-0">Android 版 VPN 客户端包括所有必需的配置，因此您可在一分钟内完成下载、安装和设置。</p>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="col-xs-12 col-sm-4">--}}
                        {{--<div class="FeatureItem text-center px-md-6 py-7 py-sm-8"><img--}}
                                    {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/onboarding/login.svg"--}}
                    ...
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="mt-7 text-center"><a class="Button Button--primary Button--block-xs mb-5" href="/zh/order/"--}}
                                                 {{--role="button" tabindex="0">立即购买</a></div>--}}
            {{--</div>--}}
        {{--</div>--}}
    {{--</section>--}}
            ...
            {{--<div class="container">--}}
                {{--<div class="row">--}}
                    {{--<div class="text-center col-lg-10 col-lg-offset-1 col-xs-12">--}}
                        {{--<h3 class="Title mb-6">轻松保障在线安全</h3>--}}
                        {{--<p class="Text mb-7">体验最好的 Android 版 VPN。</p>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="row">--}}
                    {{--<div>--}}
                        {{--<div class="col-xs-12 col-sm-6">--}}
                            {{--<div class="FeatureItem px-sm-5 px-md-6 py-7 py-sm-8"><img--}}
                                        {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/features/smart-play.svg"--}}
                                        {{--class="mb-6" alt="Stream Your Favorite Content">--}}
                                {{--<h6 class="Title base mb-3 fwm">播放您最喜欢的内容</h6>--}}
                                {{--<p class="Text small mb-0">NordVPN 应用程序采用 Smart Play 技术，通过该技术，您可以在 Android--}}
                                    {{--手机上访问热门视频流网站。</p>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div>--}}
                        {{--<div class="col-xs-12 col-sm-6">--}}
                            {{--<div class="FeatureItem px-sm-5 px-md-6 py-7 py-sm-8"><img--}}
                                        {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/features/military-grade-encryption.svg"--}}
                                        {{--class="mb-6" alt="Secure Your Internet Traffic">--}}
                                {{--<h6 class="Title base mb-3 fwm">保护您的互联网通信</h6>--}}
                                {{--<p class="Text small mb-0">NordVPN 采用军事级加密技术对您的互联网通信进行加密，这意味着没人能够窥探您的在线活动。</p>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    ...
                    {{--<div>--}}
                        {{--<div class="col-xs-12 col-sm-6">--}}
                            {{--<div class="FeatureItem px-sm-5 px-md-6 py-7 py-sm-8"><img--}}
                                        {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/features/cyber-sec.svg"--}}
                                        {{--class="mb-6" alt="Shield Yourself From Ads and Malware">--}}
                                {{--<h6 class="Title base mb-3 fwm">防止您受到广告和恶意软件的侵扰</h6>--}}
                                {{--<p class="Text small mb-0">我们采用名为 CyberSec 的最新安全特性，可阻止恼人的广告并阻止您访问带有恶意软件的网站。</p>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div>--}}
                        {{--<div class="col-xs-12 col-sm-6">--}}
                            {{--<div class="FeatureItem px-sm-5 px-md-6 py-7 py-sm-8"><img--}}
                                        {{--src="https://s1.nordwebsite.net/nordvpn/3.85.0/images/global/illustrations/features/servers-and-locations.svg"--}}
                                        {{--class="mb-6" alt="Quickly Switch Between Servers">--}}
                                {{--<h6 class="Title base mb-3 fwm">在不同服务器间快速切换</h6>--}}
                                {{--<p class="Text small mb-0">打开地图或服务器列表，可选择您的加密目的地。或者，只需点触 <b>Quick Connect</b>（快速连接），我们将选择最好的可用服务器。--}}
                                {{--</p>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        {{--<div class="clearfix"></div>--}}
            ...
            {{--<div class="row row__flex row--justify-center d-md-flex text-center">--}}
                {{--<div class="col-xs-12 col-md-4">--}}
                    {{--<div class="d-inline-block d-md-block">--}}
                        {{--<twitterwidget class="twitter-tweet twitter-tweet-rendered" id="twitter-widget-0"--}}
                                       ...
                                       {{--data-tweet-id="970644016797769728"></twitterwidget>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="col-xs-12 col-md-4">--}}
                    {{--<div class="d-inline-block d-md-block">--}}
                        {{--<twitterwidget class="twitter-tweet twitter-tweet-rendered" id="twitter-widget-1"--}}
                                       {{--style="position: static; visibility: visible; display: block; transform: rotate(0deg); max-width: 100%; width: 500px; min-width: 220px; margin-top: 10px; margin-bottom: 10px;"--}}
                                       {{--data-tweet-id="971702998845083650"></twitterwidget>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="col-xs-12 col-md-4">--}}
                    {{--<div class="d-inline-block d-md-block">--}}
                        {{--<twitterwidget class="twitter-tweet twitter-tweet-rendered" id="twitter-widget-2"--}}
                                       {{--style="position: static; visibility: visible; display: block; transform: rotate(0deg); max-width: 100%; width: 500px; min-width: 220px; margin-top: 10px; margin-bottom: 10px;"--}}
                                       {{--data-tweet-id="969865131843731456"></twitterwidget>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</div>--}}
